...
public class TransactionDao {
	...
	public List<Transaction> getTransactionsForAccounts(List<Integer> accountIds) {
		return namedParameterJdbcTemplate.query(GET_TRANSACTIONS_FOR_ACCOUNTS_SQL,
	...
	public int insert(List<Transaction> transactions) {
		return namedParameterJdbcTemplate.batchUpdate(INSERT_TRANSACTIONS_SQL,
				SqlParameterSourceUtils.createBatch(transactions.toArray())).length;
	}
}
